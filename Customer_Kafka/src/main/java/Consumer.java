    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                int id = Integer.parseInt(x[0].substring(14));
                int numOrder = Integer.parseInt(x[1].substring(12));
                int age_ = Integer.parseInt(x[2].substring(6));
                String phone = x[3].substring(14,x[3].length()-1);
                try{
